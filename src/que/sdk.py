...
import httpx
import importlib
from que import errors, models, utils
from que._hooks import HookContext, SDKHooks
from que.types import OptionalNullable, UNSET
from que.utils import get_security_from_env
from que.utils.unmarshal_json_response import unmarshal_json_response
from typing import (
    Any,
    Callable,
    Dict,
...
if TYPE_CHECKING:
    from que.asset_management import AssetManagement
    from que.utility import Utility
...
class Que(BaseSDK):
    ...
    **Authentication:**
    ...
    _sub_sdk_map = {
        "utility": ("que.utility", "Utility"),
        "asset_management": ("que.asset_management", "AssetManagement"),
    }
